...
[void]$sb.AppendLine('<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Manual de usuario - CRM Comercial</title><style>' + $style + '</style></head><body><main>')
