...
public sealed record CompanyDto(Guid Id, string Name, string Subdomain, string? CustomDomain, string? LogoDataUrl, string? ExternalInventoryWarehouseCodes, bool Active);
public sealed record UpsertCompanyDto(string Name, string Subdomain, string? CustomDomain, string? LogoDataUrl, string? ExternalInventoryWarehouseCodes, bool Active);
