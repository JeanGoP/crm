...
public enum EstadoSolicitudCredito { Borrador = 1, Cotizado = 1, DocumentosPendientes = 2, DocumentosRecibidos = 3, EnEstudio = 4, Aprobada = 5, Rechazada = 6, Desembolsada = 7, Entregada = 7, Interesado = 8, Desistida = 9 }
